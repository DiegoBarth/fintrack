      ...
      <div className="relative w-full" ref={containerRef}>
         <button
            ...
            className="flex h-10 w-full items-center justify-between rounded-md border border-gray-300 dark:border-gray-600
               bg-white dark:bg-gray-700 p-2 text-sm outline-none focus:ring-2 focus:ring-gray-300 dark:focus:ring-gray-500"
         >
         ...
         {isOpen && createPortal(
            ...
            >
               <div
                  ...
                  className="max-h-60 overflow-y-auto p-1 scroll-smooth dark:bg-gray-700 custom-scrollbar"
               >
